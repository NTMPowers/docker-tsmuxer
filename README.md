...
[Releases]: https://github.com/jlesage/docker-tsmuxer/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/tsmuxer/tags
...
container, it would proxy all HTTP requests for `tsmuxer.domain.tld` to
...
| **Application version** label | Displays the version of tsMuxeR integrated into Docker image. |
...
Any desktop notification generated by tsMuxeR is forwarded to the
